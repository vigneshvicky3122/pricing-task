        ...
        <div className="card mb-5 mb-lg-0">
          <div className="card-body">
            ...
            <ul className="fa-ul">
              ...
              <li className={props.data.isSubdomain?"":"text-muted"}><span className="fa-li"><i className={props.data.isSubdomain?"fas fa-check":"fas fa-times"}></i></span><b>{props.data.subdomain}</b></li>
